...
echo ============================================================
echo.
echo   推荐使用的外网访问地址: %CYAN%172.25.194.201%RESET%
echo.
echo   服务访问地址:
echo   ------------------------------------------------------------
echo   API 端点:     http://172.25.194.201:8081/api/v1
echo   WebSocket:    ws://172.25.194.201:8081/api/v1/ws
echo   健康检查:     http://172.25.194.201:8081/health
echo   Web 客户端:   http://172.25.194.201:3000
echo   ------------------------------------------------------------
echo.
echo   测试命令:
echo   ------------------------------------------------------------
echo   curl http://172.25.194.201:8081/health
echo   curl http://localhost:8081/health
echo   ------------------------------------------------------------
echo.
echo   注意事项:
echo   1. 确保服务已启动后再进行测试
echo   2. 从其他设备访问时使用 172.25.194.201 地址
