...
export const ENDPOINTS = {
  ...
  AUTH: {
    ...
    OAUTH_WECHAT: '/auth/oauth/wechat',
  },
  ...
  MEDIA: {
    ...
    CHUNKED_STATUS: (sessionId: string) => `/media/upload/chunked/${sessionId}/status`,
    ...
    CHUNKED_ABORT: (sessionId: string) => `/media/upload/chunked/${sessionId}/abort`,
  },
} as const;
